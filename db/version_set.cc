...
//      for (auto file : files) {
//        std::cout << "file: " << file->fd.GetPathId() << file->fd.GetNumber() << ";";
//      }
//
//      std::cout << "." << std::endl;
    ...
    bool Version::MaybeInitializeFileMetaData(FileMetaData *file_meta) {
        ...
        if (!s.ok()) {
            ROCKS_LOG_ERROR(vset_->db_options_->info_log,
                            "Unable to load table properties for file %"
                                    PRIu64
                                    " --- %s\n",
    ...
    Status VersionSet::ProcessManifestWrites(
...

        {
            ...
            if (new_descriptor_log) {
                ...
                ROCKS_LOG_INFO(db_options_->info_log, "Creating manifest %"
                        PRIu64
                        "\n",
        ...
        if (s.ok()) {
            ...
            ROCKS_LOG_INFO(
                    ...
                    "manifest_file_number is %"
                            ...
                            ",prev_log_number is %"
                            PRIu64
                            ",max_column_family is %"
                            PRIu32
                            ",min_log_number_to_keep is %"
                            PRIu64
                            "\n",
